# ![](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Android_robot.svg/32px-Android_robot.svg.png) Android - Neosurance SDK v3.0.6 Java
...
2. Then add the dependency in your application **gradle** file
	...
	dependencies {
		...
		implementation 'com.github.aleinfuNeosurance:NeosuranceSDK_v3_java:3.0.6'
	}
	```
